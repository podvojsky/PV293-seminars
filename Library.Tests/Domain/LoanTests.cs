...
public class LoanTests
{
    ...
    public void Create_SetsFields_AndStartsActive()
    {
        ...
        var loan = Loan.Create(bookId, borrowerId, "John Doe", "john@example.com", loanDurationDays: 14,
            borrowerPhoneNumber: PhoneNumber.Create("+420333222111"));
    ...
    {
        // Arrange
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Alice", "alice@example.com",
    ...
    {
        // Arrange
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Bob", "bob@example.com",
    ...
    {
        // Arrange
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Carol", "carol@example.com",
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Dan", "dan@example.com",
            PhoneNumber.Create("+420143234537"), 30);
    ...
    public void ExtendDueDate_OnlyForActiveLoans()
    {
        ...
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Eve", "eve@example.com",
            PhoneNumber.Create("+420796409586"));
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Frank", "frank@example.com",
            PhoneNumber.Create("+420090867495"));
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Gina", "gina@example.com",
            PhoneNumber.Create("+420497509938"));
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Hank", "hank@example.com",
            PhoneNumber.Create("+420372775889"));
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Ivy", "ivy@example.com",
            PhoneNumber.Create("+420998967434"));
    ...
    {
        var loan = Loan.Create(Guid.NewGuid(), Guid.NewGuid(), "Jack", "jack@example.com",
            PhoneNumber.Create("+420666884996"));
        loan.Return(); // on-time -> completes

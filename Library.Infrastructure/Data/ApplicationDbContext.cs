    ...
    : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Book>().HasData(
            new
            {
                Id = bookId1, Title = "Clean Code", AuthorId = authorId1, ISBN = "978-0132350884", Year = 2008,
                Pages = 464, Genre = "Programming", CreatedAt = DateTime.UtcNow
            },
            new
            {
                Id = bookId2, Title = "The Pragmatic Programmer", AuthorId = authorId3, ISBN = "978-0135957059",
                Year = 2019, Pages = 352, Genre = "Programming", CreatedAt = DateTime.UtcNow
            },
            new
            {
                Id = bookId3, Title = "Design Patterns", AuthorId = authorId2, ISBN = "978-0201633610", Year = 1994,
                Pages = 395, Genre = "Programming", CreatedAt = DateTime.UtcNow
            }
        );
    }
}

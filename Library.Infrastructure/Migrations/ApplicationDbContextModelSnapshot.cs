...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.Infrastructure.Entities.Loan", b =>
                {
                    b.OwnsMany("Library.Infrastructure.Entities.Fine", "Fines", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("TEXT");
                            ...
                            b1.OwnsOne("Library.Infrastructure.ValueObjects.Money", "Amount", b2 =>
                                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Library.Infrastructure.Entities.ApplicationUser", null)
                        .WithMany()
